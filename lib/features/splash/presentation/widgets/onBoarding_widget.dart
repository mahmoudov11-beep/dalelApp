...
import 'package:dalel_app/features/splash/presentation/widgets/SmoothPageIndicatorWidget.dart';
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                ...
                style: custom_text_styles.PoppinsStyleBoldSize28.copyWith(
            ...
            Padding(
              ...
              child: Text(
                ...
                style: custom_text_styles.PoppinsStyleLightSize18,
                textAlign: TextAlign.center,
              ),
            ),
            SizedBox(height: 40),
